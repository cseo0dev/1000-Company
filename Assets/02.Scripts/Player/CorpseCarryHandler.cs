...
public class CorpseCarryHandler : NetworkBehaviour
{
    ...
    {
        // Debug.Log($"[CorpseCarryHandler] TryRequestCarry 호출, corpse={corpseCondition.name}");
        ...
        {
            Debug.Log("[CorpseCarryHandler] StateAuthority가 아니라서 무시");
            return;
        }
        ...
        // 상태 세팅
        CarriedCorpse = corpseCondition.Object;
        corpseCondition.IsBeingCarried = true;
        corpseCondition.Carrier = Object;
        ...
        if (playerController != null)
        {
            ...
            playerController.CarriedPlayerId = corpseCondition.Object.Id;
        }
